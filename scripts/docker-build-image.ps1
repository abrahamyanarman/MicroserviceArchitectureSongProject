...
docker build -t armanabr/resource-service:0.0.4.1 ../resource-service/
docker build -t armanabr/song-service:0.0.3.1 ../song-service/
docker login
docker push armanabr/api-gateway:0.0.3
docker push armanabr/config-server:0.0.3
docker push armanabr/eureka-server:0.0.3
docker push armanabr/resource-service:0.0.4.1
docker push armanabr/song-service:0.0.3.1